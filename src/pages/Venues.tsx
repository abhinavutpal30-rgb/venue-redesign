...
const allVenues = [
  { id: "the-grand-palace", name: "The Grand Palace", image: "https://images.unsplash.com/photo-1519167758481-83f550bb49b3?w=600", price: "₹1,50,000", address: "Boring Road, Patna, Bihar", capacity: "200-800 guests", rating: 4.8, reviews: 124, city: "Patna", type: "Banquet Hall", budget: "premium" },
  { id: "royal-heritage-resort", name: "Royal Heritage Resort", image: "https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?w=600", price: "₹2,00,000", address: "NH-30, Patna, Bihar", capacity: "500-1500 guests", rating: 4.9, reviews: 89, city: "Patna", type: "Resort", budget: "luxury" },
  { id: "majestic-banquets", name: "Majestic Banquets", image: "https://images.unsplash.com/photo-1505236858219-8359eb29e329?w=600", price: "₹80,000", address: "Fraser Road, Patna, Bihar", capacity: "100-400 guests", rating: 4.6, reviews: 56, city: "Patna", type: "Banquet Hall", budget: "budget" },
  { id: "the-vedic-resort", name: "The Vedic Resort", image: "https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?w=600", price: "₹3,00,000", address: "Rajgir Road, Patna, Bihar", capacity: "300-1000 guests", rating: 4.7, reviews: 67, city: "Patna", type: "Resort", budget: "luxury" },
  { id: "itc-sonar", name: "ITC Sonar", image: "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=600", price: "₹5,00,000", address: "JBS Haldane Ave, Kolkata", capacity: "200-1200 guests", rating: 4.9, reviews: 210, city: "Kolkata", type: "Hotel", budget: "luxury" },
  { id: "the-oberoi-grand", name: "The Oberoi Grand", image: "https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?w=600", price: "₹4,50,000", address: "Chowringhee, Kolkata", capacity: "150-800 guests", rating: 4.8, reviews: 178, city: "Kolkata", type: "Hotel", budget: "luxury" },
  { id: "eden-gardens-banquet", name: "Eden Gardens Banquet", image: "https://images.unsplash.com/photo-1478146059778-26028b07395a?w=600", price: "₹1,20,000", address: "Park Street, Kolkata", capacity: "200-600 guests", rating: 4.5, reviews: 92, city: "Kolkata", type: "Banquet Hall", budget: "premium" },
  { id: "raichak-on-ganges", name: "Raichak on Ganges", image: "https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=600", price: "₹2,50,000", address: "Raichak, South 24 Parganas", capacity: "300-1000 guests", rating: 4.7, reviews: 143, city: "Kolkata", type: "Resort", budget: "premium" },
];
